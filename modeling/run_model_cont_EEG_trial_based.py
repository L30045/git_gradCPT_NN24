...
for subj_id in subj_id_array:
    ...
    for tt in trial_type_list:
        ...
        param_names = [name for name in glm_results.sm.params.regressor.values if name.startswith(f'{tt}_') and 'bspline' in name]
