...
dim3, group_channels, group_design_matrix = next(dm_all.iter_computational_groups(Y_all))
...
y = group_y.loc[:,'S10D127']
ar_order=30 # as default in cedalion/models/glm/solve.py > func:_channel_fit
M=sm.robust.norms.TukeyBiweight(c=4.685) # as default in cedalion/math/ar_irls.py > func:ar_irls_GLM
